...
import { clean, compact, isEmpty, isEmail, get, set, range } from 'lodash'
...
class BuySubscription extends React.PureComponent {
  ...
  async componentWillMount() {
    try{
      ...
      await this.props.dispatch(getPlan({ select: ['id', 'name','description','planCode','paymentType'], where: { permalink: permalink } }))
      ...
      <div id="buy">
        ...
        <form onSubmit={this.handleBuy.bind(this)}>
          ...
          <div className="form-group text-right">
            ...
            <h3 className={classnames({"d-inline-block": true, 'd-none': isLoading})}>
